...
export const NoteInput = () => {
  ...
  const formSubmitHandler = async (e) => {
    ...
    if (indexID !== -1) {
      ...
      postResponse = await postNoteServiceHandler({
        encodedToken: token,
        note: formData,
      });
    }
  ...
  return (
    <>
      <div className={`note-input-container ${state.displayInputModal? "viewModal": null}`}>
          ...
          <div className="card">
              ...
              <section className="card-header-container">
                <section className="card-topic-subtopic-container">
                  <h4 className="card-main-topic">
                    <input
                      type="text"
                      className="card-main-topic-input"
                      placeholder="Title..."
                      name="title"
            ...
            <section className="card-footer-container">
              ...
              <div className="footer-icon-btn-wrapper">
                <button className="card-footer-icon" type="submit">
                  Add
                </button>
              </div>
            </section>
